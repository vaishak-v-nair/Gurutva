...
.worlds{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}
...
<section id="hook"><div class="wrap">
  <h1>These four pictures all fit the same readings.</h1>
  <p class="sub">Four different arrangements of buried rock, differing by more
  than the whole body anyone is looking for. Yet they predict readings that
  sit within a whisker of each other. Ordinary software picks one of them and
  draws it for you, in colour, with no warning.</p>

  <div class="worlds">
    <figure><canvas id="w0" aria-label="Underground picture 1"></canvas>
