...
6. **The coarse-mesh error floor gets measured, not assumed**: forward-model their delivered 268,773-cell model on our 5-10k-cell mesh and publish that error budget (interface aliasing alone can exceed their 0.03 mGal floor by 10×).
